  ...
  return (
    <MobileFrame withBottomPadding>
      <View className="pt-8 space-y-4">
        <Card>
          <Text className="text-lg font-semibold text-slate-900">Tiết kiệm</Text>
          <Text className="mt-2 text-slate-600">Thông tin tiết kiệm sẽ đồng bộ giống bản web.</Text>
        </Card>
      </View>
    </MobileFrame>
  );
